        ...
        <>
            <div className="form-container">
                <form onSubmit={handleSubmit}>
                    ...
                    <select className="crete-round days-of-week" name="daysOfWeek" ref={daysRef} defaultValue={course.daysOfWeek} multiple>
                    ...
                    <button className='create-and-edit-button'>Edit Course</button>
