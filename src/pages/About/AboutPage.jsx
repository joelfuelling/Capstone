...
export default function AboutPage(){
    return(
        ...
        <h4>OnCourse is a full MERN stack application created by <a href="https://joelfuellingportfolio.netlify.app/" target="_blank" class="joel">Joel Fuelling</a> via the General Assembly Software Engingeering Immersive program.</h4>
        </div>
        </>
